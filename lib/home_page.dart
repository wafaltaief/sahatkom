    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          TextButton(
            onPressed: () {},
            child: const Text('Accueil', style: TextStyle(color: Colors.green)),
          ),
          TextButton(
            onPressed: () {},
          ...
          TextButton(
            onPressed: () {},
            child: const Text('Rendez-vous', style: TextStyle(color: Colors.green)),
          ),
          TextButton(
            onPressed: () {},
            child: const Text('Contact', style: TextStyle(color: Colors.green)),
          ),
